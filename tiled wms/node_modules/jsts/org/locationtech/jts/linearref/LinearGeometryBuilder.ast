    ...
    "declaration" : {
      ...
      "body" : {
        "body" : [ {
          ...
          "key" : {
            "name" : "setIgnoreInvalidLines",
            "type" : "Identifier"
          },
          "value" : {
            "params" : [ {
              "name" : "ignoreInvalidLines",
              "type" : "Identifier"
            } ],
            "body" : {
              "body" : [ {
